...
-- Q2. Which customer a used a discount but still spent more 
-- than avarege purchase amount
...
--  Q5. Do Subscribed customers spend more? Compare avarege spend and total revenue
-- between subscibed and non_subsscribers
...
limit 5;
-- Q7.Segment customers ino new returning,and loyal based on their total
